...
<!-- Search Form -->
<form action="searchResults.php" method="get" style="text-align: center; margin-top: 20px;">
...
<div class="header-banner">
    ...
    <p>Discover premium products tailored for you.</p>
    <a href="new.php" class="btn btn-primary">Explore Now</a>
</div>
